...
std::tuple<state_t,
    ...
    unsigned long long int, int, unsigned long long int> iteration_parser(
    ...
    options.add_options() ("h,help", "Print help")
        ...
        ("n-graph", "number of random graphs to start with", cxxopts::value<unsigned long long int>()->default_value("1"))

        ("n-fast", "number of fast iteration in-between normal iterations", cxxopts::value<unsigned long long int>()->default_value("0"))
        ("start-serializing", "iteration for which to start serializing", cxxopts::value<unsigned long long int>()->default_value("0"))

        ("n,n-iter", "number of iteration", cxxopts::value<unsigned long long int>()->default_value("3"))
        ...
        ("P,precision", "number of bits of precision", cxxopts::value<unsigned long long int>()->default_value("128"))
        ...
        ("niter-1", "number of application of the first rule per iteration", cxxopts::value<unsigned long long int>()->default_value("1"))
        ("niter-2", "number of application of the second rule per iteration", cxxopts::value<unsigned long long int>()->default_value("1"))
        ...
        ("s,size", "starting size", cxxopts::value<unsigned long long int>()->default_value("8"))
    ...
    SET_PRECISION(result["precision"].as<unsigned long long int>())
    safety_margin = result["safety-margin"].as<float>();

    // ------------------------------------------
    // parameters

    unsigned long long int n_iter = result["n-iter"].as<unsigned long long int>();
    ...
    unsigned long long int size = result["size"].as<unsigned long long int>();
    unsigned long long int num_graph = result["n-graph"].as<unsigned long long int>();
    ...
    rule->n_iter = rule->move ? result["niter-1"].as<unsigned long long int>() : 1;
    ...
    if (result.count("rule2")) {
        ...
        rule2->n_iter = rule2->move ? result["niter-2"].as<unsigned long long int>() : 1;
    }

    return {state,
        rule, rule2, 
        n_iter, result["start-serializing"].as<unsigned long long int>(), result["n-fast"].as<unsigned long long int>()};
}

std::tuple<state_t,
    state_t::rule_t*, state_t::rule_t*, 
    unsigned long long int, int> probabilist_parser(
    cxxopts::Options &options, int argc, char* argv[]) {
    ...
    options.add_options() ("h,help", "Print help")
        ...
        ("N,n-graph", "number of random graphs to start with", cxxopts::value<unsigned long long int>()->default_value("3"))
        ("start-serializing", "iteration for which to start serializing", cxxopts::value<unsigned long long int>()->default_value("0"))
    ...
    return {state,
        rule, rule2, 
        n_iter, result["start-serializing"].as<unsigned long long int>()};
}

std::tuple<state_t, state_t::rule_t*, state_t::rule_t*, unsigned long long int, int, unsigned long long int> test_parser(
    cxxopts::Options &options, int argc, char* argv[]) {
    ...
    options.add_options() ("h,help", "Print help")
        ...
        ("n,n-iter", "number of iteration", cxxopts::value<unsigned long long int>()->default_value("3"))
        ("R,n-reversed-iter", "number of reversed iteration", cxxopts::value<unsigned long long int>()->default_value("0"))
    ...
    unsigned long long int n_iter = result["n-iter"].as<unsigned long long int>();
    unsigned long long int n_reversed_iteration = result["n-reversed-iter"].as<unsigned long long int>();
    ...
    if (rule_ == "split_merge") {
        ...
        throw;
    return {state, rule, reversed_rule, n_iter, n_reversed_iteration, result["n-fast"].as<unsigned long long int>()};
}